...
class __TwigTemplate_e8dbb69a851b4b27630ce540f5afec9b5a6239952c61288b053afabaae0d5501 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][recurring_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recurring"]) {
            // line 1754
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "recurring_id", [], "any", false, false, false, 1754);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "name", [], "any", false, false, false, 1754);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][customer_group_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 1761
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 1761);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1761);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
