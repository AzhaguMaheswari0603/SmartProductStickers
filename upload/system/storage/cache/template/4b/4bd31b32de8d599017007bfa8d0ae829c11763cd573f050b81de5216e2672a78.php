...
class __TwigTemplate_a2e7a31c1ab578923abd7a064c6c33949b2070f022721d864b755896b2d6be29 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t   html = '<tr id=\"image' + image + '\">';
\t    html += '  <td class=\"text-left\"><a href=\"\" id=\"thumb-image' + image + '\"data-toggle=\"image\" class=\"img-thumbnail\"><img src=\"";
        // line 1681
        echo ($context["placeholder"] ?? null);
        echo "\" alt=\"\" title=\"\" data-placeholder=\"";
        echo ($context["placeholder"] ?? null);
        echo "\" /></a><input type=\"hidden\" name=\"product_image[' + image + '][image]\" value=\"\" id=\"input-image' + image+ '\" /></td>';
  }
  //--></script>
  <script type=\"text/javascript\"><!--
  var recurring_row = ";
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][recurring_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recurring"]) {
            // line 1692
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "recurring_id", [], "any", false, false, false, 1692);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "name", [], "any", false, false, false, 1692);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][customer_group_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 1699
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 1699);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1699);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
