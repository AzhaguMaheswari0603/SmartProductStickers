...
class __TwigTemplate_5fd54bd9d295791a90d404e4f854321f71d555281d9de1573904eef29f15996b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][recurring_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recurring"]) {
            // line 1690
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "recurring_id", [], "any", false, false, false, 1690);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "name", [], "any", false, false, false, 1690);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][customer_group_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 1697
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 1697);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1697);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
