...
class __TwigTemplate_fbc882ddfc860627d39413016d4cb78ab96d527d4292da8c8f55423dd67bc2ca extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t  html += '  <td class=\"text-left\"><select name=\"product_discount[' + discount_row + '][customer_group_id]\" class=\"form-control\">';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1604), "js");
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '  <td class=\"text-left\"><select name=\"product_special[' + special_row + '][customer_group_id]\" class=\"form-control\">';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1632), "js");
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][recurring_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recurring"]) {
            // line 1750
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "recurring_id", [], "any", false, false, false, 1750);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "name", [], "any", false, false, false, 1750);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][customer_group_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 1757
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 1757);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1757);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
