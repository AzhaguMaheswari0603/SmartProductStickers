...
class __TwigTemplate_5f01507a17f6434d92f1af0e54386d63a60c38f0e45a6a3f2b4647057a3f7f19 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t  <div class=\"form-group\">
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <button type=\"button\" id=\"button-apply\" class=\"btn btn-primary\"><i class=\"fa fa-apply\"></i> ";
        // line 1108
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][recurring_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recurring"]) {
            // line 1682
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "recurring_id", [], "any", false, false, false, 1682);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["recurring"], "name", [], "any", false, false, false, 1682);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
...
\t  html += '    <select name=\"product_recurring[' + recurring_row + '][customer_group_id]\" class=\"form-control\">>';
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 1689
            echo "\t  html += '      <option value=\"";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 1689);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 1689);
            echo "</option>';
    ";
        }
        $_parent = $context['_parent'];
