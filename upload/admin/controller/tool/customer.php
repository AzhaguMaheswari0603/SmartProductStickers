<?php
class ControllerToolcustomerimport extends Controller {
	public function index() {
		$this->load->language('tool/customer');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/customer', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['user_token'] = $this->session->data['user_token'];

		$data['export'] = $this->url->link('tool/customer/export', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('tool/customer', $data));
	}
	...
	public function export() {
		...
		if (!isset($this->request->post['customer'])) {
			...
			$this->response->redirect($this->url->link('tool/customer', 'user_token=' . $this->session->data['user_token'], true));
		} elseif (!$this->user->hasPermission('modify', 'tool/customer')) {
			...
			$this->load->model('tool/customer');

			$this->response->setOutput($this->model_tool_customer->backup($this->request->post['customer']));		
		}
	}	
}
